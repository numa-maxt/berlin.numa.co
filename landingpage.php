...
<body class="landing-page">
    <nav class="navbar navbar-transparent navbar-absolute">
    	<div class="container">
        	...
        	<div class="navbar-header">
        		...
        		<a class="navbar-brand" href="http://berlin.numa.co"><img src="assets/numa/numanuma.svg" alt="numa berlin"></a>
        	</div>
    ...
    <div class="wrapper">
        <div class="header header-filter" style="background-image: linear-gradient(0deg, rgb(9, 156, 214), rgba(9, 156, 214, 0.80)), url('https://images.unsplash.com/photo-1423655156442-ccc11daa4e99?crop=entropy&dpr=2&fit=crop&fm=jpg&h=750&ixjsv=2.1.0&ixlib=rb-0.3.5&q=50&w=1450');">
            <div class="container">
                <div class="row">
					<div class="col-md-6">
						<h1 class="title">numa berlin </h1>
	                    <h4>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque sint, inventore aliquam numquam ipsa quis porro nihil, voluptas quos fuga.</h4>
	                    <br />
